...
struct calendar_window : Window {
	calendar_window(Point xy, int w, int h, const string& title);
	Image calendar_template;
	bool wait_for_button();
	void refresh(int m, int y);
...
private:
	...
	In_box req_month;
	In_box req_year;
	Out_box current_date;
	const string event_text;
	const string day_num;
	text_cont text_box;
	bool button_pushed;
	Text* month_display;
	int current_month;
...
struct text_cont : Widget{
	text_cont(Point xy, const string day_num_txt, const string event_txt);
